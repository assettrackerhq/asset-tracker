...
func NewHandler(image, serviceAccount string, imagePullSecrets []string) *Handler {
	return &Handler{
		image:            image,
...
func (h *Handler) Generate(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.createJob(r.Context(), client, namespace, jobName); err != nil {
...
func (h *Handler) buildPodSpec() map[string]interface{} {
...
func (h *Handler) createJob(ctx context.Context, client *http.Client, namespace, jobName string) error {
	ttl := 300
	backoff := int32(0)
